...
--
-- Host: localhost
-- Generation Time: 13 Des 2017 pada 16.24
...
--
ALTER TABLE `identitas`
  MODIFY `id_identitas` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `ipk`
--
ALTER TABLE `ipk`
  MODIFY `id_ipk` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
